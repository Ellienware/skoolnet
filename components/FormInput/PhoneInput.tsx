        ...
        render={({ field: { onChange, value, ref } }) => (
          <div className="relative">
            ...
            <PhoneInput
              ...
              className={cn(
                "block w-full rounded-md border border-gray-300 bg-white py-2 pl-10 pr-3 text-sm text-gray-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500",
