    ...
    const sidebarLinks = [
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Student ID s", url: "/dashboard/students/id" },
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Leave Management", url: "/staff/leave-management" },
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Emergency Alerts", url: "/communication/emergency-alerts" },
          ],
        },
        {
          title: "Finance",
          ...
          icon: Wallet,
          items: [
            { title: "Fee Management", url: "/finance/fee-management" },
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Analytics Dashboard", url: "/reports/analytics-dashboard" },
          ],
        },
        {
          title: "Settings",
